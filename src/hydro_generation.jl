...
# Time series values are in component base. Note: purposefully NOT `get_min_active_power`.
...
# next 2 needed to avoid ambiguity errors. Note: purposefully NOT `get_max_active_power`.
